...
- Published evidence should expose both the original external document and an internal provenance record showing where the source is used in the public corpus.
