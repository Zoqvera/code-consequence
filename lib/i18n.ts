...
export const dictionary = {
  en: {
    nav: { home: "Home", initiatives: "Initiatives", radar: "Global Radar", events: "Events", topics: "Topics", about: "About" },
  ...
  "pt-BR": {
    nav: { home: "Início", initiatives: "Iniciativas", radar: "Global Radar", events: "Eventos", topics: "Temas", about: "Sobre" },
